...
class CommittedMetadataTests(unittest.TestCase):
    def test_exact_original_metadata_and_source_qualification(self):
        ...
        self.assertEqual((lock['expectedFiles'], lock['expectedBytes']), (1092, 590977579))
        self.assertEqual([r['version'] for r in lock['releases']], ['v0.91.0'])
        self.assertEqual(inventory['base'], 'https://mekhovov.github.io/revealline-archive-60/')
        release = lock['releases'][0]
        self.assertEqual(release['tagObject'], 'a13d39481346d1cc08e26ca4be47e94ece8de7a2')
        self.assertEqual(release['sourceRevision'], 'e771ca71b0e710ea878d54f8ff370707f7428ef8')
        self.assertEqual(release['sourceTree'], '9603f3df68b0b8bb8d370fdb9e83f39c9c508fe7')
        self.assertEqual(release['sourceQualification'], {
            'bytes': 14169,
            'sha256': '33d612c5339d58f1048ca7ef113ae406395543c17844f4e5eea384e808f4c064',
        ...
        cohort = [r for r in inventory['files'] if r['path'].startswith('releases/v0.91.0/')]
        self.assertEqual((len(cohort), sum(r['bytes'] for r in cohort)), (1089, 590976185))
